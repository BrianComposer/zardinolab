...
class MusicXMLExporter:
    def export(self, score: Score, output_path: str | Path, show: bool = False) -> Path:
        try:
        ...
        for measure_index, measure in enumerate(score.measures, start=1):
            ...
            for event in measure.events:
                ...
                current_note = note.Note(event.pitch, quarterLength=quarter_length)
        ...
        music21_score.insert(0, music21_part)
        if show:
            music21_score.show()
